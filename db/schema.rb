...
ActiveRecord::Schema.define(version: 2020_05_30_091635) do

  create_table "directions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.text "step"
